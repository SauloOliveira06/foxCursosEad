...
class Users_model extends CI_Model{
	...
	public function get_data($id, $select = NULL){ /* Select -> quais campos eu quero */
	...
	public function delete($id){
		$this->db->where("user_id", $id); /*verificar */
	...
	/* DATATABLES do Sistema (LSITA DE USUARIOS DE DROGAS) */
